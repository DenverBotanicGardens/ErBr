...
# don't want provisional
maxs <- grep("tmax_stable", ls_prism_data(absPath=TRUE)[,2])
mins <- grep("tmin_stable", ls_prism_data(absPath = TRUE)[,2])
ppt <- grep("ppt_stable", ls_prism_data(absPath = TRUE)[,2])
...
ggsave(filename = paste("Q:/Research/All_Projects_by_Species/Eriogonum SPECIES/Eriogonum_brandegeei/",currentyr,"_ErBr/Fig3a.jpg", sep=""),
