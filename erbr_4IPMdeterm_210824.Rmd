...
clim30yr <- read.csv("C:/Users/april/Dropbox/CU_Boulder_PhD/DBG_Internship/erbr_climData3seas32yr_221114.csv", header=TRUE)
...
chains <- readRDS("C:/Users/april/Dropbox/CU_Boulder_PhD/DBG_Internship/chains.c3t10s30b10_noYRE_210613.rds")
...
clim30yr <- clim30yr %>% mutate(PptFall1=lead(PptFall), PptWinter1=lead(PptWinter), PptSummer1=lead(PptSummer),
                   TempFall1=lead(TempFall), TempWinter1=lead(TempWinter), TempSummer1=lead(TempSummer))
clim30yr <- clim30yr[12:32,]       #Subset to only include study-period years 
