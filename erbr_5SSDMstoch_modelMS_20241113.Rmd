...
## LOAD MATRICES FOR EACH YEAR (STUDY AND NON-STUDY PERIOD) & TRANSECT FROM SSDMdeterm CODE 
mx.list <- readRDS("erbrSSDMmxList_P1k")  #Output generated from erbr_4SSDMdeterm script 
...
N.startNum <- 61              #Set starting pop size as 2022 observed size
