...
#brks <- c(20,30,40,30,40,40,40,30,40,40,30,40)
par(mfrow=c(3,2))  
hist(stoch.lams.full$LAMBDA, breaks=100, border=FALSE, xlab="Short term stochastic population growth rate",
     main=NA, cex.lab=1.4, cex.axis=1.2, xlim=c(0.9,1), col=cols[1])
abline(v=1, col="red", lwd=0.75)
hist(stoch.lams.4to13$LAMBDA, breaks=115, border=FALSE, xlab="Short term stochastic population growth rate",
     main=NA, cex.lab=1.4, cex.axis=1.2, xlim=c(0.9,1.05), col=cols[2])
abline(v=1, col="red", lwd=0.75)
hist(stoch.lams.4to13evn$LAMBDA, breaks=100, border=FALSE, xlab="Short term stochastic population growth rate",
     main=NA, cex.lab=1.4, cex.axis=1.2, col=cols[3])
abline(v=1, col="red", lwd=0.75)
hist(stoch.lams.4to13odd$LAMBDA, breaks=290, border=FALSE, xlab="Short term stochastic population growth rate",
...
abline(v=1, col="red", lwd=0.75)
hist(stoch.lams.9to13$LAMBDA, breaks=100, border=FALSE, xlab="Short term stochastic population growth rate",
     main=NA, cex.lab=1.4, cex.axis=1.2, xlim=c(0,1.1), col=cols[6])
abline(v=1, col="red", lwd=0.75)
