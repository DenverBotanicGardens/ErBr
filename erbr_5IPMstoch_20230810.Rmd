...
## UPDATED PLOT OF ESTIMATES POP SZ PER YEAR COMPARED TO OBSERVED
```{r}
...
mx.list4to13 <- readRDS("C:/Users/april/Dropbox/CU_Boulder_PhD/DBG_Internship/erbrIPMmxList_noYRE_4to13_P1k_20231026")
mx.list4to13evn <- readRDS("C:/Users/april/Dropbox/CU_Boulder_PhD/DBG_Internship/erbrIPMmxList_noYRE_4to13even_P1k_20231026")
mx.list4to13odd <- readRDS("C:/Users/april/Dropbox/CU_Boulder_PhD/DBG_Internship/erbrIPMmxList_noYRE_4to13odd_P1k_20231026")
...
pop.sz.means.consec <- pop.sz.means
pop.sz.sds.consec <- pop.sz.sds
names.yr.consec <- names.yr
pop.sz.ciHi.consec <- pop.sz.ciHi
pop.sz.ciLo.consec <- pop.sz.ciLo
...
saveRDS(pop.sz.means.full, file=paste("erbrPopSzMnFull07", date, sep="_"))
saveRDS(pop.sz.sds.full, file=paste("erbrPopSzSdFull07", date, sep="_"))
...
## PLOT PREDICTED VS OBSERVED POP SZ
## Read in saved files
pop.sz.means.full <- readRDS("C:/Users/april/Dropbox/CU_Boulder_PhD/DBG_Internship/erbrPopSzMnFull_20231229") 
pop.sz.sds.full <- readRDS("C:/Users/april/Dropbox/CU_Boulder_PhD/DBG_Internship/erbrPopSzSdFull_20231229")  
