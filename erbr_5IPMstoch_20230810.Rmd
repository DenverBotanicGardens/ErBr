...
plot(as.numeric(as.character(num.indivs$Year[4:14])), num.indivs$numIndivs[4:14], type='l', ylim=c(0,250), 
...
legend("bottomleft", c("Observed", "Full dataset", "2004-2013"), col=c("black","#d73027","#fc8d59"),lwd=2,cex=1.25,
       horiz=FALSE, bty="y",seg.len=1, xpd=TRUE)
#,"#91bfdb","#4575b4"
