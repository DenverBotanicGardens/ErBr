...
pdf('20240124_ErBr_fig4.pdf', width=6.5, height=5, pointsize=8)
plot(as.numeric(as.character(num.indivs$Year[4:14])), num.indivs$numIndivs[4:14], type='l', ylim=c(30,160), 
