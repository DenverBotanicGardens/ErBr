...
pdf('20240123_ErBr_fig3.pdf', width=6.5, height=7, pointsize=8)
...
legend("bottom", c("Full dataset", "2004-2013"), col=colz,lwd=2,
       cex=1.1, inset=c(-0.2,-0.4), xpd=TRUE, horiz=FALSE, bty="y",seg.len=1)
...
legend("bottom", c("All years", "Wettest year", "Driest year"), col="black",lwd=1,cex=1.2,
       lty=c("solid","dotted","dashed"),
       inset=c(-0.2,-0.44), xpd=TRUE, horiz=FALSE, bty="y",seg.len=1.5)
