...
legend("bottom", c("Full", "2004-2013", "2004-2013 even", "2004-2013 odd"), col=colz,lwd=2,
       cex=1.1, inset=c(-0.2,-0.64), xpd=TRUE, horiz=FALSE, bty="y",seg.len=1)


plot(vrs.param$SZ[1:bin.num], vrs.mean$MEAN_SURV, xlab="Plant size in t (rosette number)", 
     ylab="Survival probability", type='l',lwd=2,cex.lab=1.5, cex.axis=1.25, col="#d73027",ylim=c(0.6,1))
...
legend("bottom", c("All years", "Wettest year", "Driest year"), col="black",lwd=0.75,cex=1.2,
       lty=c("solid","dotted","dashed"),
       inset=c(-0.2,-0.62), xpd=TRUE, horiz=FALSE, bty="y",seg.len=1)
