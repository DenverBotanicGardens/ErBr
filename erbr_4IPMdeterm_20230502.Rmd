...
##READ IN SAVED FILE
lam.out.param <- readRDS("C:/Users/april/Dropbox/CU_Boulder_PhD/DBG_Internship/ErBr/erbrLams_noYRE_P1k_20230503")
...
legend("bottom", c("All", "Wet", "Dry"), col=c("black","dodgerblue","red"),lwd=2,cex=1.35,
       inset=c(-0.2,-0.42), xpd=TRUE, horiz=TRUE, bty="n",seg.len=1)
...
lam.out.param.comb <- dplyr::left_join(lam.out.param.comb, clim32yr, by="YEAR")
...
## ** ARE THESE STILL THE BEST CLIM VARS TO BE CONSIDERING? LOOK AT MODELS USED FOR EACH VR **** 
