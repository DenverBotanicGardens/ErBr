...
## Modify 'life history' for Medium Growth to get additional simulated datasets
...
setwd("C:/Users/Dan Doak/Desktop/Students/April/eriogonum models/manu fall2024/Sept 27 debugging simulateddata/mediumgrow")
...
minsize <- 1
maxsize <- 100#(max(erbr$RosNew, na.rm=TRUE)) 
