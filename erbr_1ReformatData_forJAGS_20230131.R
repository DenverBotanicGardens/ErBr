...
## MEDL Test
# tt <- "W.1.1" ## MEDL: first seen in 2008, in year 4 get integer(0) for goodpastyrs and then Inf for lagsrtsz and lagforsurv
# tt <- "W.4.304.1"
# tt <- "E.1.20"
...
table(dats2$lagforsurv) #MEDL: X times for Inf that might all be the first time a plant was seen
