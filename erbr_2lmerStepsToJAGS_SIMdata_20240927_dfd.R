...
setwd("C:/Users/Dan Doak/Desktop/Students/April/eriogonum models/manu fall2024/Sept 27 debugging simulateddata/sept 28 20yr Miss")
...
jags.mod <- run.jags('erbr_3JAGSmodBest_noYRE_20230418shortTrunc.R', n.chains=3, data=dats, burnin=10000, thin=5, sample=10000, adapt=500, method='parallel')
